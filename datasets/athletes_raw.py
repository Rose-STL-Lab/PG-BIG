...
from common.paths import get_kinematic_directory, get_participants_info_directory
...
class Athlete183RawDataset(Dataset):
    ...
    def get_subject_info(self):
        kinematic_directory = get_kinematic_directory(self.base_directory)
        ...
        participants_info_dir = get_participants_info_directory(self.base_directory)
