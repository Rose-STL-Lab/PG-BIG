...
class Retargeted183Dataset(data.Dataset):
    def __init__(self, window_size=64, unit_length=4, data_dir=ATHLETES_183_RETARGETED_DIR, pre_load=False):
...
def retargeted183_data_loader(window_size=64, unit_length=4, batch_size=1, num_workers=0, data_dir=ATHLETES_183_RETARGETED_DIR, pre_load=False):
    """
    Create a DataLoader for the 183_athletes retargeted dataset optimized for multiple workers.
