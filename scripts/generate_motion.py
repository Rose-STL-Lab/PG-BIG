...
from profile import model as profile_modules
import profile.config_prior as option_subject_prior
...
def main():
    ...
    parser.add_argument('--dataset-path', type=str, default='./dataset/183_athletes/retargeted')
